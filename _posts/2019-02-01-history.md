...
.language-code2{ display:none; }
</style>
<button onclick="showcode()" class="showbutton">Show Code</button>
<button onclick="showcode()" style="display:none;">Hide Code</button>
...
<script> 
    function showcode2() {  
    $('.showbutton2').toggle(); 
    $('.language-code2').toggle(); 
    } 
</script> 
<button onclick="showcode2()" class="showbutton2">Show Code</button> 
<button onclick="showcode2()" style="display:none;">Hide Code</button>
